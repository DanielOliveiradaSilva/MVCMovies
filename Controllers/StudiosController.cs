...
namespace MvcMovie.Controllers
{
    public class StudiosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudioId,Name,Coutry")] Studio studio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudioId,Name,Coutry")] Studio studio)
        {
